...
const Cats = () => {
  ...
  // Your Cat API key here (get it from https://thecatapi.com/)
  const API_KEY = 'live_aX3NYnBFPEPVMWRGPsP4iHfWG28dvbnRLBDUKNmXnUbr5RozxTyTxZTKQCLZDSSY'; // Replace with your actual API key
